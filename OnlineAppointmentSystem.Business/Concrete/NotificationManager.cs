...
namespace OnlineAppointmentSystem.Business.Concrete
{
    public class NotificationManager : INotificationService
    {
        ...
        public async Task<bool> SendSmsNotificationAsync(NotificationDTO notificationDTO)
        {
            try
            {
                // Bu işlemi repository'de özel bir metot olarak uygulamanız gerekebilir
        ...
        public async Task ProcessPendingNotificationsAsync()
        {
            try
            {
                ...
                foreach (var notification in pendingNotifications)
                {
                    ...
                    else if (notification.NotificationType.Equals("SMS", StringComparison.OrdinalIgnoreCase))
                    {
                        sent = await SendSmsNotificationAsync(notificationDTO);
                    }
